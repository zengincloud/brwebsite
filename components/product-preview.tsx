  ...
  return (
    <div className="relative max-w-5xl mx-auto">
      <div className="bg-white border border-[var(--sand-5)] shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="flex lg:hidden overflow-x-auto border-b border-[var(--sand-4)] bg-[var(--sand-2)] scrollbar-none">
          {navItems.map((item) => (
            <button
              key={item.id}
              onClick={() => setActive(item.id)}
              className={`flex items-center gap-1.5 px-3 py-2.5 text-[11px] whitespace-nowrap shrink-0 border-b-2 transition-colors ${
                active === item.id
        ...
        <div className="flex min-h-[420px]">
          ...
          <div className="hidden lg:flex w-40 shrink-0 border-r border-[var(--sand-4)] bg-[var(--sand-2)] p-3 flex-col gap-0.5">
