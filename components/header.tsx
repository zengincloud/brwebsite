...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/10 backdrop-blur-2xl border-b border-white/20 shadow-[inset_0_-1px_0_0_rgba(255,255,255,0.04)]">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white/10 backdrop-blur-2xl border-b border-white/20">
